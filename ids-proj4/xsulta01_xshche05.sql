...
It reports if the required quantity of any ingredient exceeds available stock, allowing visibility into potential stock shortages.
*/
...
--         DBMS_OUTPUT.PUT_LINE('Order status is not NEW. Cannot validate stock.');
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            DBMS_OUTPUT.PUT_LINE('No data found for order ID: ' || p_order_id);
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Error validating stock for order: ' || SQLERRM);
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Error calculating total sales: ' || SQLERRM);
...
BEGIN
    -- Check if the car is already assigned to a courier
    SELECT courier_id INTO v_current_courier_id
    FROM Car
...
-- 1. order_date_before_insert_or_update (generate exception)
-- INSERT INTO Orders (order_customer_id, order_status, order_delivery_option, order_date, order_price, order_comment)
-- VALUES (1, 'NEW', 'COURIER_DELIVERY', TO_DATE('04-04-2025', 'DD-MM-YYYY'), 100, 'Please deliver ASAP.');


-- 2. delivery_ticket_date_before_insert_or_update (generate exception)
-- INSERT INTO Delivery_Ticket (courier_id, address_id, order_id, delivery_date, time_from, time_to)
-- VALUES (3, 1, 1, TO_DATE('2020-07-16', 'YYYY-MM-DD'),
--         TO_TIMESTAMP('2020-07-16:09:00:00', 'YYYY-MM-DD:HH24:MI:SS'),
--         TO_TIMESTAMP('2020-07-16:12:00:00', 'YYYY-MM-DD:HH24:MI:SS'));
